...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RvRevvaN80', 0, 'z4iTm5LESf1PAPNIlYWPTo', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'});
    }
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'KnpSnappyBundle' => array(
                    'parent' => NULL,
                    'path' => 'F:/development/www/shikoba/vendor/knplabs/knp-snappy-bundle',
