...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\ParteFormType' => function () {
    return ${($_ = isset($this->services['form.parteType']) ? $this->services['form.parteType'] : $this->load(__DIR__.'/getForm_ParteTypeService.php')) && false ?: '_'};
